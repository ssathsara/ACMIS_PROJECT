...
<body>
  ...
  <div class ="right">
      ...
      <div class="container">
        ...
        <div class="content">
          <ul>
            <li><div class="title"><img  class="admin-home-img" src="<?php echo base_url('assests/img/update.png')?>"></a><a href="<?php echo site_url('Yf_function/view_update_newsfeed');?>">Update Newsfeed</a></div></li>

            <li><div class="title"><a href="#"><img  class="admin-home-img" src="<?php echo base_url('assests/img/cutom/add-2.png')?>"></a><a href="<?php echo site_url('Yf_function/propose_event_budget');?>">Propose Budget</a></div></li>

            <li><div class="title"><a href="#"><img  class="admin-home-img" src="<?php echo base_url('assests/img/update_event.png')?>"></a><a href="<?php echo site_url('yf_function/update_event');?>">View Budget</a></div></li>
