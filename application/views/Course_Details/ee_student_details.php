 <div class ="right">
      ...
      <div class="container" style="height: 700px;">
        <h4>Engish Enrichment- Student Details</h4>
          <center>
          ...
          <a href="<?php echo base_url('index.php/Course_details/remove_ee_details');?>"><button class="course-btn">Clear Table</button></a>
         </center>   
